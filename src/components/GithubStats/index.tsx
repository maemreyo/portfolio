...
export const GithubStats = () => {
  return (
    <div id="github-stats" className="mt-24">
      ...
      <div className="flex">
        <img
          src={`${process.env.REACT_APP_GIT_STATS}?username=maemreyo&show_icons=true&theme=vue&hide=prs,issues,contribs`}
        />
        <img
          src={`${process.env.REACT_APP_GIT_STREAK}?user=maemreyo&theme=vue`}
        />
        <img
          src={`${process.env.REACT_APP_GIT_STATS}/top-langs/?username=maemreyo&langs_count=6&hide=rust`}
        />
        <img
